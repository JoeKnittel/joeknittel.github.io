---
title: "Graphing Libraries, Part 1 : Interactivity Plots in R and Python"
output:
  md_document:
    variant: gfm
    preserve_yaml: TRUE
...
Next time, we'll talk about databases, how to configure R to connect to them, and how to explore work with them using SQL commands.
