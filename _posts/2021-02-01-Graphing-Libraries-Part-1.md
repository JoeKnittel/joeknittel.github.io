---
title: "Graphing Libraries, Part I: Interactive Plots Using R and Python"
output:
  md_document:
    variant: gfm
    preserve_yaml: TRUE
...
In this post, we'll take data visualization to the next level, as we investigate some of my favorite R and Python packages that provide interactivity (i.e., the user can directly interact with the visualizations).
...
The next library we'll look at is <a href = "https://jkunst.com/highcharter/">Highcharter</a>, which is a wrapper for <a href = "https://www.highcharts.com/">Highcharts</a>, a commonly-used JavaScript visualization library.  
